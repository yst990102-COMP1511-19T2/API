...
int main(int argc, char *argv[]) {
    ...
    int data[argc];
    struct node *head = strings_to_list(length, argv + 3, nodes, data);
    ...
    check_list("the list returned by insert_nth", new_head, length, NULL, data);

    printf("insert_nth returned: ");
    print_list(new_head);
    printf("\n");
