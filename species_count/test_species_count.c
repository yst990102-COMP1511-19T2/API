...
static int read_sightings_file(char filename[], int len, struct pod sightings[len]);
static int read_sighting(FILE *f, struct pod *w);
static int read_date(FILE *f, struct date *d);
...
static int read_sighting(FILE *f, struct pod *s) {
